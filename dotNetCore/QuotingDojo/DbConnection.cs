...
namespace DbConnection
{
    public class DbConnector
    {
        ...
        static string db = "oforie"; //Change to your schema name
        ...
        internal static IDbConnection Connection {
            get {
                return new MySqlConnection($"Server={server};Port={port};Database={db};UserID={user};Password={pass};SslMode=None; Convert Zero Datetime=True; Allow Zero Datetime=True");
            }
        }
